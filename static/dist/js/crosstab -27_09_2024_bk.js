                            ...
                            if (get_facts_colorizer_object != "") {
                               ...
                               var matchingValues = getMatchingValues_facts_in_row_level(facts_coorizer_div_array_1,row_k1,row_k2);
                                ...
                                if (Object.keys(matchingValues).length !== 0) {
                                    ...
                                    html +='<th scope="row" class="text-right" style="color:'+get_color[1]+';background-color:'+grand_total_bg+';">'+addThousandSeparators(val_text)+''+varPercent+'</th>';

                                }else{
                                    html +='<th scope="row" class="text-right" style="color:'+find_color_code[0]+';background-color:'+grand_total_bg+';">'+addThousandSeparators(val_text)+''+varPercent+'</th>';
                                }
