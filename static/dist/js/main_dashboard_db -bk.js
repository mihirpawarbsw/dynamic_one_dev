...
var csrfmiddlewaretoken=csrftoken;
   ...
   setTimeout(function () { 
			...
			respdata2 = autoresponse("get_electrolux_india_column", checkData2);		
...
function display_leftside_menu(resp){
	...
	var ii=0;
	var j=0;
	var tab_name_array=['India',"china"];
	var resp_len=Object.keys(tab_name_array).length;
	var columns_name_tp=[]
	console.log('resp_len',resp_len)
	// $.each(resp['colname_dict_final'], function (table_name, value1) {
		var get_all_column_name=Object.keys(resp['data']);
	 for (var w = 0; w<resp_len; w++) {
	 	console.log('loop',w)

		console.log('table_name==>',tab_name_array,'values==>',get_all_column_name)
    ...
    //     });
		...
		html +='<a class="child text-truncate w-75"    >'+tab_name_array[w]+'</a>';
		html +='</li>';
		 for (var z = 1; z<50; z++) {
		...
		// for (var ww = 0; ww<get_all_column_value.length; ww++) {
			// console.log('line63 value2',value2['id'])
		...
		// // 	// c_data=exract_one_array_object_by_data(value2);
			...
			html +='<a class="child text-truncate w-75" data-toggle="tooltip" data-placement="right" >'+data1[z]+'</a>';
			html +='</li>';
	...
	// console.log('final table columns_name_tp',columns_name_tp)
