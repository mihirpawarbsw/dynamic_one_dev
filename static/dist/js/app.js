var example1 = document.getElementById('example1'),
	...
	example33 = document.getElementById('example33');
	sTreePlus = document.getElementById('sTreePlus');
	sTree2 = document.getElementById('sTree2');
	example3_section = document.getElementById('example3_section');
...
new Sortable(example33, {
	group: 'shared',
	animation: 150
});
new Sortable(sTreePlus, {
	group: 'shared',
	animation: 150
});
new Sortable(sTree2, {
