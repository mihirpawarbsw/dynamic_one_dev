...
// var API_URL='https://dynamicview.brand-scapes.com/';
...
function autoresponse(zurl, data) {
    ...
    var zapiurl = API_URL + zurl;
    var formData = data;
    var maxRetries = 3; // Number of retry attempts
    var attempt = 0;
    ...
    function sendRequest() {
        $.ajax({
            ...
            async: false, // Keeping it as per your existing code
            success: function (data) {
                resultobj = data;
            },
            error: function (xhr, textStatus) {
                if (textStatus === "timeout") {
                    hidePreloader();
                    // console.error("Request timed out. Attempt:", attempt + 1);
                    swal({title: "Error!",
                    ...
                    hidePreloader();
                    // console.error("Request failed:", textStatus, "Status Code:", xhr.status);
                    swal({title: "Error!",
...
function header_stacked_logic(html,group_column_resp,single_row_length,row_str,columns_data,resp){
    ...
    console.log('group_column_resp-->1111',group_column_resp)
    ...
    // console.log('group_column_resp_keyname--->985',resp['df_cross_json']['columns'][0].length)
        ...
        const group_column_resp_result = createNestedStructure(columns_data);
        const numberOfLevels = getNestedLevels(group_column_resp_result);
        console.log('group_column_resp_result 1111',group_column_resp_result)
                ...
                if (column_length==2) {
                    ...
                    var get_facts_colorizer_object=$("#facts_coorizer_div_array").html();
                        ...
                        if (get_facts_colorizer_object!="") {
                            ...
                            // console.log(' column_length 2',dropdown_match_index_key)
                        }
                    ...
                    if (resp['measure_type']=='measure_in_column') {
                        ...
                        // console.log('sort_flag_array 1 and 2',sort_flag_array)
                         if (k3.indexOf("Rank") !== -1) {
                            ...
                            var sort_arrow_code='<span class="column_level_'+header_i+' mr-3" id="column_level_'+header_i+'" data-sortflag="desc_sort" data-column1="'+sort_flag_array+'" onclick="table_sorting_function(this)"><i class="fa fa-sort" aria-hidden="true" style="font-size:12px; cursor:pointer; position:relative; left:7px; color:white;"></i></span>';
                        }
    ...
    console.log('grand_total_index_array-->1111',grand_total_index_array)
    // console.log('dropdown_match_index_key--->600 line',dropdown_match_index_key)
        ...
        $.each(group_column_resp_result, function (k2, val2) {
            ...
            $.each(val2, function (k3, val3) {
                ...
                if (column_length==2) {
                    ...
                    var get_facts_colorizer_object=$("#facts_coorizer_div_array").html();
                    console.log('get_facts_colorizer_object level 2',get_facts_colorizer_object)
                        if (get_facts_colorizer_object!="") {
                            var get_facts_colorizer_json=JSON.parse(get_facts_colorizer_object);
                             // console.log('get_facts_colorizer_json',get_facts_colorizer_json)
                            var matchingValues = getMatchingValues(header_i,get_facts_colorizer_json,k2,k3,val3,0,k2);
                ...
                if (column_length==3) {
                    ...
                    $.each(val3, function (k4, val4) {
                        ...
                        var get_facts_colorizer_object=$("#facts_coorizer_div_array").html();
                        console.log('get_facts_colorizer_object level 3',get_facts_colorizer_object)
                        if (get_facts_colorizer_object!="") {
                            var get_facts_colorizer_json=JSON.parse(get_facts_colorizer_object);
                             // console.log('get_facts_colorizer_json',get_facts_colorizer_json)
                            var matchingValues = getMatchingValues(header_i,get_facts_colorizer_json,k2,k3,val4,0,k2);
...
function getMatchingValues(index,facts_colorizer_array,L1,L2,L3,flag,tpname) {
    ...
    // console.log('getMatchingValues fun--> flag',flag)
    // return false;
    if (flag===0) {
...
function adduseractivity(){
    ...
    var data = {'pagevisited':pathname,'csrfmiddlewaretoken': csrfmiddlewaretoken}
 
    var response = autoresponse('adduseractivity',data);
