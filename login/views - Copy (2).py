...
def logout(request):
    ...
    # Check the URL and redirect accordingly
    if host == 'https://shiseido.brand-scapes.com/Onedashboardhome':
        return redirect('https://shiseido.brand-scapes.com/logout')  # Redirect to a specific page for abc.com
    elif host == 'http://apps.brand-scapes.com/onedashboard/Onedashboardhome':
        return redirect('http://apps.brand-scapes.com/onedashboard/logout')  # Redirect to a different page for xyz.com
    else:
...
def landingpage(request):
    ...
    request.session['host'] = url_param

    # loginpassword =  'Bc$!T00l@2024'

    print('loginemail---> 9000',loginemail)
    print('url_param---> 9000',url_param)
