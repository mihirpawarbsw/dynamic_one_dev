...
def base_filter_data_OLD_18022025(df, dict_base_filter_data):
    print("==== FUNCTION base_filter_data STARTED!")
    print('df colss 1677777',df.columns)
    # dict_base_filter = {
    #     'Gender': ['Female'],
...
def base_filter_resp_all_OLD_18022025(df, dict_table, row_name, col_name):
    print('======== base_filter_resp =======')
    # print('row_name===',row_name)
    # print('col_name===',col_name)
    ####################### BASE FILTER #####################################################################
