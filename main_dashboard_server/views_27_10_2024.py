...
def metrics_filter_call(request):
    if request.method == "POST":
        ...
        rowfilter_sort = request.POST.get('rowfilter_sort')
        columnfilter_sort = request.POST.get('columnfilter_sort')
        ...
        print('rowfilter_sort',rowfilter_sort)
        print('columnfilter_sort',columnfilter_sort)
